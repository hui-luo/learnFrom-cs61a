...
print(max_scoring_num_rolls(dice, total_samples=1)) # dice is 2 for the first 55 rolls, then is 1 followed by 2 for 1000 rolls
7
...
def hog_pile_strategy(score, opponent_score, threshold=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if not hefty_hogs_strategy(score, opponent_score, threshold , num_rolls):
        return 0
